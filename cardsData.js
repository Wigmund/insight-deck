...
const cardsData = [
    ...
    {
        id: "arch01", type: "archetype", title: "The Pioneer", traditional: "The Fool",
        essence: "The embodiment of fearless exploration, embracing new beginnings with optimism and an open heart.",
    ...
    {
        id: "arch02", type: "archetype", title: "The Alchemist", traditional: "The Magician",
        essence: "The skillful transformer of ideas into reality, wielding resources with confidence and creativity.",
    ...
    {
        id: "arch03", type: "archetype", title: "The Sage", traditional: "The High Priestess",
        essence: "The guardian of inner wisdom, perceiving underlying currents and unspoken truths with profound insight.",
    ...
    {
        id: "arch04", type: "archetype", title: "The Visionary", traditional: "The Empress",
        essence: "The nurturer of growth and abundance, fostering creativity and creating harmonious, supportive environments.",
    ...
    {
        id: "arch05", type: "archetype", title: "The Architect", traditional: "The Emperor",
        essence: "The master of structure and order, establishing clear foundations and systems for stability and achievement.",
    ...
    {
        id: "arch06", type: "archetype", title: "The Mentor", traditional: "The Hierophant",
        essence: "The keeper of wisdom and tradition, guiding others through established knowledge and shared values.",
    ...
    {
        id: "arch07", type: "archetype", title: "The Harmonizer", traditional: "The Lovers",
        essence: "The builder of authentic connections and aligned choices, valuing collaboration and relational integrity.",
    ...
    {
        id: "arch08", type: "archetype", title: "The Driver", traditional: "The Chariot",
        essence: "The focused force of will and determination, overcoming obstacles to achieve ambitious goals with directness.",
    ...
    {
        id: "arch09", type: "archetype", title: "The Warrior", traditional: "Strength",
        essence: "The embodiment of courage, resilience, and compassionate influence, taming challenges with inner fortitude.",
    ...
    {
        id: "arch10", type: "archetype", title: "The Thinker", traditional: "The Hermit",
        essence: "The seeker of knowledge and profound understanding, offering insights gleaned from introspection and analysis.",
    ...
    {
        id: "arch11", type: "archetype", title: "The Catalyst", traditional: "Wheel of Fortune",
        essence: "The agent of change and adaptation, recognizing and embracing life's cycles and turning points.",
    ...
    {
        id: "arch12", type: "archetype", title: "The Advocate", traditional: "Justice",
        essence: "The champion of fairness, truth, and accountability, making balanced decisions based on ethical principles.",
    ...
    {
        id: "arch13", type: "archetype", title: "The Transformer", traditional: "The Hanged Man",
        essence: "The embracer of new perspectives through surrender and pause, willing to see things differently for deeper learning.",
    ...
    {
        id: "arch14", type: "archetype", title: "The Liberator", traditional: "Death",
        essence: "The facilitator of necessary endings and profound transformations, clearing the way for new beginnings.",
    ...
    {
        id: "arch15", type: "archetype", title: "The Synergist", traditional: "Temperance",
        essence: "The masterful blender of diverse elements, fostering balance, integration, and harmonious solutions.",
    ...
    {
        id: "arch16", type: "archetype", title: "The Revealer", traditional: "The Devil",
        essence: "The courageous confronter of limiting beliefs and shadow patterns, empowering through radical honesty.",
    ...
    {
        id: "arch17", type: "archetype", title: "The Disruptor", traditional: "The Tower",
        essence: "The catalyst for sudden, necessary upheaval, clearing away false structures to reveal truth and enable rebuilding.",
    ...
    {
        id: "arch18", type: "archetype", title: "The Inspirer", traditional: "The Star",
        essence: "The beacon of hope, authenticity, and higher purpose, radiating optimism and promoting healing.",
    ...
    {
        id: "arch19", type: "archetype", title: "The Navigator", traditional: "The Moon",
        essence: "The intuitive guide through uncertainty and the subconscious, understanding complex emotions and hidden paths.",
    ...
    {
        id: "arch20", type: "archetype", title: "The Illuminator", traditional: "The Sun",
        essence: "The bringer of clarity, joy, and vital energy, radiating confidence and fostering success and understanding.",
    ...
    {
        id: "arch21", type: "archetype", title: "The Assessor", traditional: "Judgement",
        essence: "The agent of clear evaluation and renewal, learning from the past to embrace a higher calling and new purpose.",
    ...
    {
        id: "arch22", type: "archetype", title: "The Integrator", traditional: "The World",
        essence: "The embodiment of completion, fulfillment, and successful integration, celebrating wholeness and accomplishment.",
    ...
    // Fire (Continuing from previous 3)
    {
        ...
        description: "The initial burst of inspiration, the courage to begin something new, the raw spark of creative potential.",
    ...
    },
    {
        ...
        description: "I confidently map out the initial steps of a new venture or direction, leaning into the system's desire for change.",
    ...
    },
    {
        ...
        description: "I take the first tangible steps, exploring new territory and anticipating growth for the system.",
    ...
    },
    {
        ...
        description: "I acknowledge and celebrate initial successes, building team spirit and stabilizing system morale.",
    ...
    },
    {
        ...
        description: "I engage with diverse perspectives and constructive conflict to refine ideas and strengthen system outcomes.",
    ...
    },
    {
        ...
        description: "I inspire and lead others towards a shared goal, celebrating collective achievement and system success.",
    ...
    },
    {
        ...
        description: "I stand firm for my convictions or a system's necessary stance, even amidst challenges or competition.",
    ...
    },
    {
        ...
        description: "I move quickly and decisively, bringing projects to a swift conclusion or propelling the system to its next phase.",
    ...
    },
    {
        ...
        description: "I maintain strength and determination even when the system is weary, guarding past achievements and pushing through.",
    ...
    },
    {
        ...
        description: "I take on significant responsibility, often completing a major cycle of effort for the system.",
    ...
    // Water (Continuing from previous 3)
    {
        ...
        description: "I am the wellspring of empathy, intuition, and authentic relationship, sensing the 'Emotional Field'.",
    ...
    },
    {
        ...
        description: "I focus on creating strong, respectful one-on-one connections and partnerships within the system.",
    ...
    },
    {
        ...
        description: "I foster joy and camaraderie within a group, celebrating shared successes and support for the '3rd Entity'.",
    ...
    },
    {
        ...
        description: "I encourage pausing to consider feelings and current offerings, discerning what is truly valuable for the system.",
    ...
    },
    {
        ...
        description: "I acknowledge and learn from relational setbacks or emotional losses, seeking what remains valuable for system healing.",
    ...
    },
    {
        ...
        description: "I draw on positive past experiences and simple kindness to build trust and goodwill within the system.",
    ...
    },
    {
        ...
        description: "I navigate multiple emotional options or imaginative ideas for the system, seeking clarity before committing.",
    ...
    },
    {
        ...
        description: "I recognize when it's time for the system to leave a situation or emotional state that no longer serves, seeking deeper fulfillment.",
    ...
    },
    {
        ...
        description: "I appreciate and enjoy the emotional and relational abundance the system has achieved; a sense of collective well-being.",
    ...
    },
    {
        ...
        description: "I cultivate lasting emotional well-being, strong team bonds, and overall fulfillment within the system.",
    ...
    // Air (Continuing from previous 3)
    {
        ...
        description: "I am the moment of pure clarity, the new idea, the truth revealed, encouraging open 'Ventilation'.",
    ...
    },
    {
        ...
        description: "I carefully weigh options, seeking a balanced perspective before making a difficult choice for the system.",
    ...
    },
    {
        ...
        description: "I confront painful realities or necessary feedback to enable clarity and healing within the system.",
    ...
    },
    {
        ...
        description: "I advocate for rest and mental recuperation to regain clarity and strategic perspective for the system.",
    ...
    },
    {
        ...
        description: "I analyze system conflict to understand different viewpoints, even if it means acknowledging a 'loss' to gain insight.",
    ...
    },
    {
        ...
        description: "I guide system movement from a difficult mental space or situation towards a clearer, more promising future.",
    ...
    },
    {
        ...
        description: "I employ clever thinking and sometimes indirect approaches to navigate complex system situations or achieve goals.",
    ...
    },
    {
        ...
        description: "I identify and challenge self-imposed mental restrictions or limiting beliefs within the system.",
    ...
    },
    {
        ...
        description: "I confront and process system anxieties and worries, seeking collective mental peace and resilience.",
    ...
    },
    {
        ...
        description: "I represent the definitive end of a system's thought process or difficult situation, bringing painful but necessary clarity for a new start.",
    ...
    // Earth (Continuing from previous 3)
    {
        ...
        description: "I am the seed of a practical venture, a new resource, or a grounded opportunity for system growth.",
    ...
    },
    {
        ...
        description: "I skillfully juggle multiple priorities or resources, adapting to changing demands for system efficiency.",
    ...
    },
    {
        ...
        description: "I focus on quality work, collaboration with other skilled individuals, and building a strong reputation for the system.",
    ...
    },
    {
        ...
        description: "I prudently manage and conserve system resources, ensuring stability and security for its future.",
    ...
    },
    {
        ...
        description: "I help the system face periods of material lack or exclusion, seeking support and opportunities for recovery.",
    ...
    },
    {
        ...
        description: "I facilitate fair and balanced giving and receiving of resources, mentorship, or support within the system.",
    ...
    },
    {
        ...
        description: "I assess progress on long-term system investments of time or resources, patiently awaiting results.",
    ...
    },
    {
        ...
        description: "I commit to diligent work, honing skills, and taking pride in detailed craftsmanship for system excellence.",
    ...
    },
    {
        ...
        description: "I encourage the system to enjoy the fruits of its labor, self-reliance, and disciplined effort, appreciating material comfort and security.",
    ...
    },
    {
        ...
        description: "I help build and maintain lasting structures, wealth, or traditions that provide security and continuity for the system's future.",
    ...
    // Fire
    {
        ...
        principle: "Bringing parts of a system into proper relative position to serve a common goal, even without full agreement. Fosters movement from 'Interests in Common'.",
    ...
    },
    {
        ...
        principle: "Trusting and amplifying subtle system 'Signals' (both verbal and non-verbal) to reveal 'what is trying to happen' and unlock generative potential.",
    ...
    },
    {
        ...
        principle: "Adopting a light, curious, and experimental approach ('Playfulness') to try new behaviors or solutions without fear of failure, fostering learning and adaptability.",
    ...
    },
    {
        ...
        principle: "Clearly articulating and consistently communicating a compelling shared purpose or vision that energizes and aligns system efforts towards a 'High Dream'.",
    ...
    // Water
    {
        ...
        principle: "Co-creating the culture, atmosphere, and ground rules for how a relationship system (team, partnership) will consciously function and interact.",
    ...
    },
    {
        ...
        principle: "Exploring and appreciating diverse perspectives and experiences ('My Land, Your Land, Our Land') within a system to bridge differences and build shared understanding.",
    ...
    },
     {
        ...
        principle: "Cultivating an environment where individuals feel safe to take interpersonal risks, speak up, admit mistakes, and be vulnerable without fear of negative consequences.",
    ...
    },
    {
        ...
        principle: "A simple, powerful process of sharing and receiving appreciation to increase positivity, fill the 'emotional bank account,' and soften the 'Emotional Field'.",
    ...
    // Air
    {
        ...
        principle: "Ensuring all voices within a system, especially marginalized or unpopular ones, are heard and considered to gain a fuller, more accurate picture of reality.",
    ...
    },
    {
        ...
        principle: "Visually mapping system dynamics, roles, and relationships ('Informal Constellations') to gain a 'snapshot,' reveal hidden patterns, and make the invisible visible.",
    ...
    },
    {
        ...
        principle: "Shifting the focus from individual blaming or issues to the '3rd Entity' – the relationship or system itself – as the client, fostering shared responsibility and solutions.",
    ...
    },
     {
        ...
        principle: "Utilizing powerful, open-ended questions and 'Inquiry/Awareness' to 'peel the onion,' uncover underlying assumptions, and stimulate strategic thinking within the system.",
    ...
    // Earth
    {
        ...
        principle: "Identifying and addressing toxic communication patterns (Blaming, Defensiveness, Contempt, Stonewalling) and co-creating antidotes or 'Conflict Protocols'.",
    ...
    },
    {
        ...
        principle: "Uncovering, honoring, and consciously working with the foundational stories, guiding narratives ('Original Myth'), and 'High Dreams' of a relationship or system.",
    ...
    },
    {
        ...
        principle: "Facilitating the clear definition, understanding, and effective population of 'Roles' within a system to ensure functions are met and 'Role Nausea/Confusion' is minimized.",
    ...
    },
    {
        ...
        principle: "Establishing the necessary practical and relational foundations ('Ground Conditions for Successful Change') for any system initiative to thrive and achieve sustainable results.",
